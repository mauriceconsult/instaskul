...
export const CourseAttachmentsForm = ({ initialData, adminId, courseId }: CourseAttachmentsFormProps) => {
  ...
  const onSubmit = async (url: string) => {
    try {
      await axios.post(`/api/admins/${adminId}/courses/${courseId}/attachments`, { url });
  ...
  const onDelete = async (id: string) => {
    try {
      setDeletingId(id);
      await axios.delete(`/api/admins/${adminId}/courses/${courseId}/attachments/${id}`);
