...
export const NoticeboardActions = ({
  ...
  const onClick = async () => {
    try {
      ...
      if (isPublished) {
        await axios.patch(
          `/api/admins/${adminId}/noticeboards/${noticeboardId}/unpublish`
        );
        toast.success("Noticeboard unpublished");
      } else {
        await axios.patch(
          `/api/admins/${adminId}/noticeboards/${noticeboardId}/publish`
        );
  ...
  const onDelete = async () => {
    try {
      setIsLoading(true);
      await axios.delete(`/api/admins/${adminId}/noticeboards/${noticeboardId}`);
